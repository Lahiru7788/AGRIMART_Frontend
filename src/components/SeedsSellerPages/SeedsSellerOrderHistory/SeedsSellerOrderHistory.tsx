...
const ConsumerOrderHistory = () => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            const response = await axios.get(`http://localhost:8081/api/user/viewSFOrdersByConsumerID/${userID}`);

            if (response.data && response.data.sfOrderGetResponse) {
                const ordersData = response.data.sfOrderGetResponse;
    ...
    const handleUpdateOrder = (order) => {
        ...
        router.push(`/seedsSellerUpdateProductDetailsPage?orderDetails=${encodedOrder}&productID=${order.productID}&orderID=${order.orderID}`);
    };
    ...
    const deleteOrder = async () => {
        ...
        try {
            ...
            await axios.put(`http://localhost:8081/api/user/sf-order-products/${selectedOrder.orderID}/delete`);
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                <h2 className="text-xl font-poppins-bold text-gray-800">
                                    Seeds & Fertilizer Seller Farmer Product Orders ({filteredOrders.length})
                                </h2>
