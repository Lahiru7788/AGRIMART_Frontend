...
const CourseCard = ({ course, onUpdateClick, onDeleteClick }) => {
    ...
    const handleDelete = async () => {
        try {
            await axios.put(
                `http://localhost:8081/api/user/trainer-course/${course.courseID}/delete`,
                {},
    ...
    // Handle update click - redirect to update page
    const handleUpdateClick = () => {
        router.push(`/trainerUpdateCourseDetails?courseID=${course.courseID}`);
    };
        ...
        <div className={`${cardShadowClass} w-full mb-4 p-4`}>
            <div className="flex">
                ...
                <div className="flex-1 pr-8">
                    ...
                    <h3 className="text-xl font-poppins-bold mb-3">
                        {course.courseName}
                    </h3>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-3">
                        <div>
                            <p className="text-gray-600 font-poppins-bold text-sm">Drive Link:</p>
                            <a href={course.driveLink} target="_blank" rel="noopener noreferrer" className="text-blue-600 font-poppins-regular text-sm hover:underline truncate block">
                                {course.driveLink}
                            </a>
                        </div>
                        <div>
                            <p className="text-gray-600 font-poppins-bold text-sm">YouTube Link:</p>
                            <a href={course.youtubeLink} target="_blank" rel="noopener noreferrer" className="text-blue-600 font-poppins-regular text-sm hover:underline truncate block">
                                {course.youtubeLink}
                            </a>
                        </div>
                    </div>
            ...
            <div className="absolute bottom-4 right-4 flex gap-4">
                <button
                    className="text-green-600 text-3xl font-bold hover:text-green-800 transition-colors"
                ...
                <button
                    className="text-red-600 text-3xl font-bold hover:text-red-800 transition-colors"
                    ...
                    <div className="bg-white rounded-lg p-6 max-w-md mx-4 shadow-xl" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="mb-6">
                            <p className="text-gray-700 font-poppins-regular">
                                Are you sure you want to delete course <span className="font-poppins-bold">{course.courseName}</span>?
                            </p>
...
const CourseList = () => {
    ...
    const fetchCourses = async () => {
        try {
            ...
            const activeCourses = courseList.filter(course => course.deleted !== true);
