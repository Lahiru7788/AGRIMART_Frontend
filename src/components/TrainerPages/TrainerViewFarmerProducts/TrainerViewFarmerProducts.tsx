...
import ProductDetailsPage from "../TrainerViewProductsDetailsPage/TrainerViewProductsDetailsPage";
...
const ProductCard = ({ product, onViewDetails }) => {
    ...
    const OnViewDetails = () => {
        if (product.user && product.user.userID) {
            // Use query parameter instead of path parameter
            router.push(`/trainerViewProductDetailsPage?productID=${product.productID}`);
        }
    };
