...
const ConsumerOrderHistory = () => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            const response = await axios.get(`http://localhost:8081/api/user/viewTrainerOrdersByTrainerID/${userID}`);

            if (response.data && response.data.trainerOrderGetResponse) {
                const ordersData = response.data.trainerOrderGetResponse;
    ...
    const handleUpdateOrder = (order) => {
        ...
        router.push(`/trainerUpdateProductDetailsPage?orderDetails=${encodedOrder}&productID=${order.productID}&orderID=${order.orderID}`);
    };
    ...
    const deleteOrder = async () => {
        ...
        try {
            ...
            await axios.put(`http://localhost:8081/api/user/trainer-order-products/${selectedOrder.orderID}/delete`);
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                <h2 className="text-xl font-poppins-bold text-gray-800">
                                    Trainer Farmer Product Orders ({filteredOrders.length})
                                </h2>
