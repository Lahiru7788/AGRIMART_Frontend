    ...
    const cardData = [
        {
            ...
            imageSrc:"/Images/HeaderNav/fproduct.jpg",
            buttonText:"View Products",
            targetPath: "/consumerViewFarmerProducts"
        },
        {
        ...
        },
        {
            ...
            targetPath: "/ConsumerViewTrainerCourses&Services"
        }
    ];
