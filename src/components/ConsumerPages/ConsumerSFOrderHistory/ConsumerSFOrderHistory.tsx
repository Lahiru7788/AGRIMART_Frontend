...
const ConsumerOrderHistory = () => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            const response = await axios.get(`http://localhost:8081/api/user/viewConsumerSeedsOrdersByConsumerID/${userID}`);

            if (response.data && response.data.consumerSeedsOrderGetResponse) {
                const ordersData = response.data.consumerSeedsOrderGetResponse;
    ...
    const handleUpdateOrder = (order) => {
        ...
        router.push(`/consumerUpdateSFProductDetailsPage?orderDetails=${encodedOrder}&productID=${order.productID}&orderID=${order.orderID}`);
    };
    ...
    const deleteOrder = async () => {
        ...
        try {
            ...
            await axios.put(`http://localhost:8081/api/user/consumer-seedsOrder-products/${selectedOrder.orderID}/delete`);
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                <h2 className="text-xl font-poppins-bold text-gray-800">
                                    Consumer Seeds or Fertilizer Orders ({filteredOrders.length})
                                </h2>
