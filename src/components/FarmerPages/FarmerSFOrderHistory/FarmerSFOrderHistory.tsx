...
const ConsumerOrderHistory = () => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            const response = await axios.get(`http://localhost:8081/api/user/viewFarmerSeedsOrdersByFarmerID/${userID}`);

            if (response.data && response.data.farmerSeedsOrderGetResponse) {
                const ordersData = response.data.farmerSeedsOrderGetResponse;
    ...
    const handleUpdateOrder = (order) => {
        ...
        router.push(`/farmerUpdateSFProductDetailsPage?orderDetails=${encodedOrder}&productID=${order.productID}&orderID=${order.orderID}`);
    };
    ...
    const deleteOrder = async () => {
        ...
        try {
            ...
            await axios.put(`http://localhost:8081/api/user/farmer-seedsOrder-products/${selectedOrder.orderID}/delete`);
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                <h2 className="text-xl font-poppins-bold text-gray-800">
                                    Farmer Seeds or Fertilizer Orders ({filteredOrders.length})
                                </h2>
