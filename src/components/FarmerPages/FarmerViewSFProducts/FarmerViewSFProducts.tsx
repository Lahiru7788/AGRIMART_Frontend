...
import ProductDetailsPage from "../FarmerViewSFProductDetailsPage/FarmerViewSFProductDetailsPage";
...
const ProductCard = ({ product, onViewDetails }) => {
    ...
    const OnViewDetails = () => {
        if (product.user && product.user.userID) {
            // Use query parameter instead of path parameter
            router.push(`/farmerViewSFProductDetailsPage?productID=${product.productID}`);
        }
    };
