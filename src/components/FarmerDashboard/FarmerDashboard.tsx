...
const Sidebar = () => {
    return (
        <aside className="w-64  bg-white rounded-xl shadow-lg p-6 flex flex-col justify-between fixed">
            {/* Logo Section */}
            <div>
                ...
                <nav className="mt-8 space-y-6 font-poppins-regular">
                    ...
                    <LinkItem href="/add-product" icon={<PlusCircle size={20} />} label="Add Product" />
                    <LinkItem href="/update-product" icon={<Package2 size={20} />} label="Update Product" />
