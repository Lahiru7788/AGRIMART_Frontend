...
interface ApiResponse {
    ...
    supermarketSeedsOrderGetResponse?: RawOrder[];
...
const ConsumerNotificationSystem = () => {
    ...
    const fetchNotifications = async () => {
        try {
            ...
            const apiEndpoints = [
                `http://localhost:8081/api/user/viewSupermarketOrdersByConsumerID/${userID}`,
                `http://localhost:8081/api/user/viewSupermarketSeedsOrdersByConsumerID/${userID}`,
            ];
    ...
    const handleNotificationClick = (notification: NotificationData) => {
        ...
        switch (notification.type) {
            case 'Farmer':
                ...
                routePage = '/supermarketViewProductDetailsPage';
                break;

            case 'Seeds & Fertilizer Seller':
                productObject = notification.rawOrder.sfProduct;
                productID = notification.rawOrder.sfProduct?.productID;
                routePage = '/supermarketViewSFProductDetailsPage'; // Assuming different page for SF products
                break;
